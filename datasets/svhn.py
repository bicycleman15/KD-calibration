...
def get_datasets(args):
    trainset = datasets.SVHN(root='~/scratch/Data', split="train", download=True, transform=None)
    testset = datasets.SVHN(root='~/scratch/Data', split="test", download=True, transform=None)
