...
def get_train_valid_test_loader(args):
    train_set = datasets.CIFAR10(root='~/scratch/Data', train=True, download=True, transform=transform_train)
    val_set = datasets.CIFAR10(root='~/scratch/Data', train=True, download=True, transform=transform_test)
    ...
    test_set = datasets.CIFAR10(root='~/scratch/Data', train=False, download=False, transform=transform_test)
...
def get_datasets(args):
    trainset = datasets.CIFAR10(root='~/scratch/Data', train=True, download=True, transform=None)
    testset = datasets.CIFAR10(root='~/scratch/Data', train=False, download=False, transform=None)
